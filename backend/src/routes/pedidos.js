...
router.get('/admin/taxa-cancelamento', authorize('admin', 'funcionario'), pedidoController.taxaCancelamento);
router.get('/admin/cross-sell', authorize('admin', 'funcionario'), pedidoController.crossSell);
...
router.patch('/:id/status', authorize('admin', 'funcionario'), pedidoController.atualizarStatus);
