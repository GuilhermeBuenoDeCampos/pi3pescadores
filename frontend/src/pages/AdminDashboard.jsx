...
const kpiCalculations = {
  ...
  leadtime: {
    ...
    description: 'Calcula a média entre os horários registrados no funil: entrada no site, primeiro item no carrinho, pagamento confirmado, preparando, enviado e concluído.',
  },
};
...
function AdminDashboard() {
  ...
  const leadtimeEtapas = [
    ...
    ['Enviado -> concluído', 'enviado_concluido'],
  ].map(([label, key]) => {
    ...
    <main className={styles.page}>
      <aside className={styles.sidebar}>
        ...
        <nav className={styles.sidebarNav} aria-label="Menu administrativo">
          ...
          <button className={styles.navItem} type="button" onClick={() => navigate('/admin/usuarios')}><FiUsers /> Usuários</button>
        ...
        <section className={styles.conversionSection} aria-label="Taxa de conversão">
          ...
          >
            ...
            <button
              ...
              title="Configurar taxa de conversão"
            >
              <FiSettings size={18} color="#10182c" />
            </button>
