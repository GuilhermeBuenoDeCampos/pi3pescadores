...
exports.obterKpisSatisfacao = async () => {
  const [result] = await db.sequelize.query(`
    SELECT
      ...
      SUM(CASE WHEN ROUND(nota) = 1 THEN 1 ELSE 0 END) AS nota_1,
      SUM(CASE WHEN ROUND(nota) = 2 THEN 1 ELSE 0 END) AS nota_2,
      SUM(CASE WHEN ROUND(nota) = 3 THEN 1 ELSE 0 END) AS nota_3,
      SUM(CASE WHEN ROUND(nota) = 4 THEN 1 ELSE 0 END) AS nota_4,
      SUM(CASE WHEN ROUND(nota) = 5 THEN 1 ELSE 0 END) AS nota_5,
